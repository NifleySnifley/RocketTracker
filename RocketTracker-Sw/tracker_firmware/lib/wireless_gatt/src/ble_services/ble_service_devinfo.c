...
static uint8_t devInfoModelNumber[DEVINFO_STR_ATTR_LEN + 1] = "0";

// Serial Number String characteristic
static uint8_t devInfoSerialNumber[DEVINFO_STR_ATTR_LEN + 1] = "0";

// Firmware Revision String characteristic
static uint8_t devInfoFirmwareRev[DEVINFO_STR_ATTR_LEN + 1] = "0.1 dev";

// Hardware Revision String characteristic
static uint8_t devInfoHardwareRev[DEVINFO_STR_ATTR_LEN + 1] = "1";

// Software Revision String characteristic
static uint8_t devInfoSoftwareRev[DEVINFO_STR_ATTR_LEN + 1] = "0.1";

// Manufacturer Name String characteristic
static uint8_t devInfoMfrName[DEVINFO_STR_ATTR_LEN + 1] = "tinkerneering.com";
